...
sudo apt install gcc gdb vim neovim make cmake gawk git golang rustc neofetch ffmpeg podman qemu-system-arm qemu-system-x86 qemu-utils qemu-user-static keepass2 vlc fcitx5 fcitx5-pinyin python3-pip
